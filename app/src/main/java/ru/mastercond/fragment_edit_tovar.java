...
public class fragment_edit_tovar extends Fragment {

  private SQLiteConnect DB;
  private SetDynamicHeightListView SetDListView;

  public fragment_edit_tovar() {}

  AlertDialog.Builder deltovardialog;
  ...
  public View onCreateView(
    ...
    View rootView = inflater.inflate(R.layout.fragment_edit_tovar, container, false);
   ...
   //region ПЕРЕМЕННЫЕ
    ...
    final String ID = rootActivity.gettovarid();
    ...
    final Button ButtonDelTovar=(Button)rootView.findViewById(R.id.buttondel);
   ...
   //region СЕКЦИЯ ЗАПОЛНЕНИЯ СТРАНИЦЫ ДАННЫМИ ИЗ БД
    ...
    try {
      ...
      SQLiteDatabase db = DB.getReadableDatabase();
      Cursor cursor = db.rawQuery("SELECT * FROM TOVARI WHERE ID = " + ID, null);
      cursor.moveToNext(); //без этого exception
      //0 - это ID 1- IDD
    ...
    ButtonSaveDBDisk.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        try {
          ...
          final String s11;
          if (! ETTovarMainFont.getText().toString().equals("")) { s11= "<body style=\"font-family:"+ ETTovarMainFont.getText().toString()+";\">\r\n";} else {s11="<body>";}
          ...
          String s14= "<!--ОСНОВНОЙ КОНТЕНТ СТРАНИЦЫ--><div class=\"container\" style=\"margin-top:107px;\"><p><a href=\"index.php\" style=\"color:" + ETTovarNavLinkTextColor.getText().toString() + ";\">Главная</a>\r\n";
    ...
    ButtonSaveUpload.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        try {
          ...
          MainActivity rootActivity = (MainActivity) getActivity();
          //rootActivity.savePHPFile(String FolderName, String SubFolderName, String FileName, String str)
          //rootActivity.uploadPHPFile("Мастерконд", "", ETTovarFileName.getText().toString(), TovarPHPCode);
        }
        catch (SQLException mSQLException) {
          Toast.makeText(getActivity(), mSQLException.toString(), Toast.LENGTH_LONG).show();
        }
   ...
   //region КНОПКА УДАЛИТЬ ТОВАР
    ...
    ButtonDelTovar.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {


        deltovardialog = new AlertDialog.Builder(container.getContext());
        deltovardialog.setCancelable(true);
        ...
        deltovardialog.setView(dialogView);
        final AlertDialog deldialog = deltovardialog.create();
        ...
        Zagolovok.setText("Удалить товар из базы?");
        ...
        btn_positive.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            Toast.makeText(getActivity(), "Товар успешно удален из базы", Toast.LENGTH_LONG).show();
            deldialog.cancel();
            MainActivity rootActivity = (MainActivity) getActivity();
            rootActivity.tovarclose();
