    ...
    //=================КОНЕЦ СЕКЦИЯ ЗАПОЛНЕНИЯ СТРАНИЦЫ ДАННЫМИ ИЗ БД=================
        ...
        DBsaveFirmKontragent.setOnClickListener(new View.OnClickListener() {
           ...
           try {
            ...
            DB.ChangeMyFirm(ID,FullNameStr,SokrNameStr,INNStr,KPPStr,OGRNStr,BankNameStr,BankBIKStr,BankKSStr,BankRSStr,RukDolzhnStr,VliceStr,FIOrukStr,UrAddrStr,FaktAddrStr,PostAddrStr, PhoneStr,MobileStr,EmailStr,SiteStr, SMyLogo, SMyPechat, SMySlogan);
