...
public class Documents_MakeNakladnaja {


//ДЛЯ ПОЛУЧЕНИЯ ФАЙЛА НАКЛАДНОЙ НЕОБХОДИМО СТРОГО СОБЛЮДАТЬ ПОСЛЕДОВАТЕЛЬНОСТЬ ФОРМИРОВАНИЯ ДОКУМЕНТА:
//Documents_MakeNakladnaja.getOsnova1 ()
//Documents_MakeNakladnaja.getShapka2 (String Imgaddr, String Slogan, String Site, String Phone)
//Documents_MakeNakladnaja.getNachaloNakladnojSection3 (String NaklNomer, String NaklData, String DogovorNomer, String DogovorData, String GorodZaklDogovora)

//Documents_MakeNakladnaja.getTovarUslugа4 (String Number, String Naimenovanie, String EdIzm, String Kolvo, String CenaZaEd, String Stoimost)

//Documents_MakeNakladnaja.getNakladnajaEndTable5 (String Stoimost, String StoimostPropis, String NomerovPoNakladnoj)
//Documents_MakeNakladnaja.getRekvizitiStoron6 (String MySokrName, String MyUrAddr, String MyFactAddr, String MyOGRN, String MyINN, String MyKPP, String MyRS, String MyBankName, String MyBankBIK, String MyBankKS, String MyPhone, String MyMobile, String MyEmail, String MySite, String MyOtvetstvennij, String KontrSokrName, String KontrUrAddr, String KontrFactAddr, String KontrINN, String KontrKPP, String KontrOGRN, String KontrBankRekv, String KontrPhone, String KontrMobile, String KontrEmail, String KontrSite, String KontrOtvetstvennij) 

//ИЛИ 7 ИЛИ 8 В ЗАВИСИМОСТИ ОТ ТИПА ДОКУМЕНТА
//Documents_MakeNakladnaja.getDogovorEnd7 (String MyRukDolzhnost, String MyFIORuk, String KontrRukDolzhnost, String KontrFIOruk, String DataDogovora) - без печати
//Documents_MakeNakladnaja.getDogovorEndPechat8 (String MyRukDolzhnost, String MyFIORuk, String KontrRukDolzhnost, String KontrFIOruk, String DataDogovora, String MoiPechatPodpis) - с печатью




// ------1-------- ОСНОВА (ВНУТРЕННЯЯ РАЗМЕТКА)
...
//------2-------- ШАПКА С ЛОГОТИПОМ И СЛОГАНОМ
...
//------3-------- СЕКЦИЯ НАЧАЛА НАКЛАДНОЙ

public String getNachaloNakladnojSection3 (String NaklNomer, String NaklData, String DogovorNomer, String DogovorData, String GorodZaklDogovora)
{


                String s1 = "<h1 class=\"P54\">ТОВАРНАЯ НАКЛАДНАЯ № Н-" + NaklNomer + "</h1><p class=\"P25\"> </p><p style=\"font-family:Tahoma; font-size:8.5pt; text-align:center; font-weight:bold; \">к Договору № "+DogovorNomer+" от "+DogovorData+"</p>\r\n";
                ...
                String s4 = "<td style=\"text-align:right; \"><span class=\"T7\">" + NaklData + "</span></td>\r\n";
                String s5 = "</tr></table><p class=\"P25\"> </p>";
                String s6 = "<table width=\"100%\" border=\"1px\" cellspacing=\"0\" cellpadding=\"0\" width=\"100% \" style=\"border-color:#999999;\"><tr><td width=\"10px\"><p class=\"P150\">№</p></td><td width=\"10cm\"><p class=\"P150\">Наименование товаров и услуг</p></td><td width=\"30px\"><p class=\"P150\">Кол-во</p></td><td width=\"40px\"><p class=\"P150\">Ед.изм.</p></td><td width=\"50px\"><p class=\"P150\">Цена за ед,₽</p></td><td width=\"60px\"><p class=\"P150\">Стоимость,₽</p></td></tr>\r\n";
...
public String getNakladnajaEndTable5 (String Stoimost, String StoimostPropis, String NomerovPoNakladnoj) {

                    String s1 = "</table><p class=\"P25\"> </p><p style=\"font-family:Tahoma; font-size:7.5pt; text-align:left; font-weight:bold; \">Товарная накладная содержит " + NomerovPoNakladnoj + " порядковых номеров записей</p><p class=\"P25\"> </p>\r\n";
                String s2 = "<p class=\"P25\"> </p><p style=\"font-family:Tahoma; font-size:7.5pt; text-align:left; font-weight:bold; \">Общая стоимость отгруженных товаров: " + Stoimost + " рублей ("+StoimostPropis+"), НДС не облагается в соответствии с п.2 ст.346.11 Налогового кодекса Российской Федерации</p><p class=\"P25\"> </p><p class=\"P25\"> </p>\r\n";

                String s3 = "<p class=\"P50\">ГРУЗ ПРИНЯЛ___________________________________________________________________________ПО ДОВЕРЕННОСТИ №____________________ОТ______________________</p>";
                String s4 = "<p class=\"P50\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(должность, ФИО)</p><p class=\"P25\"> </p>";

                String s5 = "<p class=\"P50\">Перечисленные выше товары со стороны Исполнителя Заказчику в полном объеме и в оговоренные Сторонами сроки были переданы.</p><p class=\"P25\"> </p><p class=\"P113\">ЗАКАЗЧИК К ИСПОЛНИТЕЛЮ ПРЕТЕНЗИЙ НЕ ИМЕЕТ.</p>";
...
public String getNakladnajaEnd7 (String MyRukDolzhnost, String MyFIORuk, String KontrRukDolzhnost, String KontrFIOruk, String DataDogovora)
...
public String getNakladnajaEndPechat8 (String MyRukDolzhnost, String MyFIORuk, String KontrRukDolzhnost, String KontrFIOruk, String DataDogovora, String MoiPechatPodpis)
