...
public class fragment_add_zametka extends Fragment {
   ...
   final Spinner SpinnerDay=(Spinner)rootView.findViewById(R.id.spinnerday);
   final Spinner SpinnerMonth=(Spinner)rootView.findViewById(R.id.spinnermonth);
   final Spinner SpinnerYear=(Spinner)rootView.findViewById(R.id.spinneryear);
   
   
   final Calendar today = Calendar.getInstance();
   SpinnerDay.setSelection(today.get(Calendar.DAY_OF_MONTH)-1);
   SpinnerMonth.setSelection(today.get(Calendar.MONTH));
   SpinnerYear.setSelection(today.get(Calendar.YEAR)-1980); // выбрать 2020 год (нулевой элемент 1980 год)
