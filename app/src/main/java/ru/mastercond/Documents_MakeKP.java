...
public class Documents_MakeKP {

//ДЛЯ ПОЛУЧЕНИЯ ФАЙЛА СМЕТЫ НЕОБХОДИМО СТРОГО СОБЛЮДАТЬ ПОСЛЕДОВАТЕЛЬНОСТЬ ФОРМИРОВАНИЯ ДОКУМЕНТА:
//Documents_MakeKP.getOsnova1 ()
//Documents_MakeKP.getShapka2 (String Imgaddr, String Slogan, String Site, String Phone)
//Documents_MakeKP.getNachaloSmetiSection3 (String SmetaNomer, String SmetaData, String UslugiPo, String GorodZaklDogovora, String MyFullName, String MyVlice, String KontrSokrName)

//Documents_MakeKP.getTovarUslugа4 (String Number, String Naimenovanie, String EdIzm, String Kolvo, String CenaZaEd, String Stoimost)

//Documents_MakeKP.getSmetaEndTable5 (String Stoimost, String StoimostPropis, String UslovijaSmeti) 
//Documents_MakeKP.getRekvizitiStoron6 (String MySokrName, String MyUrAddr, String MyFactAddr, String MyOGRN, String MyINN, String MyKPP, String MyRS, String MyBankName, String MyBankBIK, String MyBankKS, String MyPhone, String MyMobile, String MyEmail, String MySite, String MyOtvetstvennij, String KontrSokrName, String KontrUrAddr, String KontrFactAddr, String KontrINN, String KontrKPP, String KontrOGRN, String KontrBankRekv, String KontrPhone, String KontrMobile, String KontrEmail, String KontrSite, String KontrOtvetstvennij) 

//ИЛИ 7 ИЛИ 8 В ЗАВИСИМОСТИ ОТ ТИПА ДОКУМЕНТА
//Documents_MakeKP.getSmetaEnd7 (String MyRukDolzhnost, String MyFIORuk, String KontrRukDolzhnost, String KontrFIOruk, String DataDogovora) - без печати
//Documents_MakeKP.getSmetaEndPechat8 (String MyRukDolzhnost, String MyFIORuk, String KontrRukDolzhnost, String KontrFIOruk, String DataDogovora, String MoiPechatPodpis) - с печатью
...
//------3-------- СЕКЦИЯ НАЧАЛА СМЕТЫ

public String getNachaloSmetiSection3 (String SmetaNomer, String SmetaData, String UslugiPo, String GorodZaklDogovora, String MyFullName, String MyVlice, String KontrSokrName)
{


                String s1 = "<h1 class=\"P54\">КОММЕРЧЕСКОЕ ПРЕДЛОЖЕНИЕ № КП-" + SmetaNomer + " на поставку товаров и оказание услуг по " + UslugiPo + "</h1><p class=\"P25\"> </p><p style=\"font-family:Tahoma; font-size:8.5pt; text-align:center; font-weight:bold; \">для " + KontrSokrName + " от " + SmetaData + "</p>\r\n";
                ...
                String s4 = "<td style=\"text-align:right; \"><span class=\"T7\">" + SmetaData + "</span></td>\r\n";
                String s5 = "</tr></table><p class=\"P25\"> </p><p class=\"P25\"> </p>\r\n";

                String s6 = "<p class=\"P50\">Потенциальный Исполнитель " + MyFullName + ", в лице " + MyVlice + ", предлагает " + KontrSokrName + " свои товары и услуги:</p><p class=\"P25\"> </p>\r\n";
                String s7 = "<p class=\"P25\"> </p><p class=\"P13\">ПЕРЕЧЕНЬ ТОВАРОВ И УСЛУГ</p><p class=\"P25\"> </p>\r\n";
...
public String getSmetaEndTable5 (String Stoimost, String StoimostPropis, String UslovijaSmeti) {

String s1 = "</table><p class=\"P25\"> </p><p style=\"font-family:Tahoma; font-size:7.5pt; text-align:left; font-weight:bold; \">Общая стоимость товаров и услуг: " + Stoimost + " рублей (" + StoimostPropis + "), НДС не облагается в соответствии с п.2 ст.346.11 Налогового кодекса Российской Федерации</p><p class=\"P25\"> </p><p class=\"P25\"> </p>\r\n";
                String s2 = "<p class=\"P50\">"+UslovijaSmeti+"</p><p class=\"P25\"> </p>";
...
{               
                ...
                String s2 = "<table border=\"1px\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" style=\"border-color:#999999;\"><tr><td width=\"50%\" style=\"text-align:center;\" ><p class=\"P13\">ПОТЕНЦИАЛЬНЫЙ ИСПОЛНИТЕЛЬ:</p><p class=\"P25\"> </p></td><td width = \"50%\" style=\"text-align:center;\"><p class=\"P13\">ЗАКАЗЧИК:</p><p class=\"P25\"> </p></td></tr>\r\n";
...
public String getSmetaEnd7 (String MyRukDolzhnost, String MyFIORuk, String KontrRukDolzhnost, String KontrFIOruk, String DataDogovora)
...
public String getSmetaEndPechat8 (String MyRukDolzhnost, String MyFIORuk, String KontrRukDolzhnost, String KontrFIOruk, String DataDogovora, String MoiPechatPodpis)
